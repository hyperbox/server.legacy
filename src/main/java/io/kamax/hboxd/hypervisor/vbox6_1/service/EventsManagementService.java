...
package io.kamax.hboxd.hypervisor.vbox6_1.service;
...
import io.kamax.hboxd.hypervisor.vbox6_1.ErrorInterpreter;
import io.kamax.hboxd.hypervisor.vbox6_1.VBox;
import io.kamax.hboxd.hypervisor.vbox6_1.factory.EventFactory;
        ...
        try {
            ...
            if (rawEvent != null) {
                ...
                if (preciseRawEvent != null) {
                    log.debug("Event was processed to {} - {} - {}", preciseRawEvent.getClass().getName(), preciseRawEvent.getType(), preciseRawEvent);
            ...
            if ((r.getMessage() != null) && r.getMessage().contains("Connection refused")) {
                log.debug("Virtualbox Web Service disconnected, stopping the service", r);
                stop();
            } else {
                throw r;
            }
