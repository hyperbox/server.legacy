...
package io.kamax.hboxd.hypervisor.vbox6_1.factory;
...
import io.kamax.hboxd.hypervisor.vbox6_1.VBoxOsType;
...
public final class OsTypeFactory {
    ...
    public static MachineData getSettings(IGuestOSType guestOs) {
        MachineData vm = new MachineData();
