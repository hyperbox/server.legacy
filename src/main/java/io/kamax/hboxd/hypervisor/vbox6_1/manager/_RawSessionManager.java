...
package io.kamax.hboxd.hypervisor.vbox6_1.manager;
...
public interface _RawSessionManager {
     ...
     */
    ISession lock(String uuid, LockType lockType) throws MachineLockingException;
     ...
     * @throws MachineLockingException If an error occurred when trying to lock the machine
     */
    ISession lockAuto(String uuid, LockType lockType) throws MachineLockingException;
     ...
     * @throws MachineLockingException If an error occurred when trying to lock the machine
     */
    ISession lockAuto(String uuid) throws MachineLockingException;
    ...
    void unlock(String uuid, boolean saveSettings);
     ...
     */
    void unlockAuto(String uuid, boolean saveSettings);
     ...
     */
    IMachine getCurrent(String uuid);
